file:///D:/GitHub/lecture-projects/FrameworkLab/javaPlay/app/controllers/ContactsController.java
...
action parameters:
offset: 1752
uri: file:///D:/GitHub/lecture-projects/FrameworkLab/javaPlay/app/controllers/ContactsController.java
text:
```scala
package controllers;
...
public class ContactsController extends Controller {
    ...
    public CompletionStage<Result> index() {
        try {
            ...
            retur@@n CompletableFuture.completedFuture(internalServerError("System error occurred"));
        }
    }
